...
func (s *Service) Create(ctx context.Context, in PlanManagerInput) (*PlanManager, error) {
	...
	s.hub.Broadcast(realtime.Event{TenantID: tenantID, Entity: "plan_manager", UUID: p.UUID, Action: "create"})
	return p, nil
}
...
func (s *Service) Update(ctx context.Context, uuid string, in PlanManagerInput) (*PlanManager, error) {
	...
	s.hub.Broadcast(realtime.Event{TenantID: tenantID, Entity: "plan_manager", UUID: p.UUID, Action: "update"})
	return p, nil
}
...
func (s *Service) Delete(ctx context.Context, uuid string) error {
	...
	s.hub.Broadcast(realtime.Event{TenantID: tenantID, Entity: "plan_manager", UUID: p.UUID, Action: "delete"})
	return nil
}

// ResolvePlanManagerIDs translates a list of plan-manager uuids into their int
...
func (s *Service) ResolvePlanManagerIDs(ctx context.Context, pmUUIDs []string) ([]int64, error) {
	tenantID := reqctx.MustTenant(ctx)
	return s.repo.ResolvePlanManagerIDs(ctx, tenantID, pmUUIDs)
}
...
func (s *Service) BulkDelete(ctx context.Context, ids []int64) error {
	...
	s.hub.Broadcast(realtime.Event{TenantID: tenantID, Entity: "plan_manager", UUID: "", Action: "bulk_delete"})
	return nil
}
