<script lang="ts">
	...
	const features = [
		{ title: 'Local-First', details: 'Your data lives on your device in SQLite. No servers, no telemetry, no subscriptions.' },
...
<svelte:head>
	<title>Tallyo — Local-First Invoice Management</title>
</svelte:head>
