...
│   ├── (app)/              # App routes (wrapped in FileGate + AppShell)
│   │   ├── catalog/        # /catalog pages
│   │   ├── clients/        # /clients pages
│   │   ├── estimates/      # /estimates pages
│   │   ├── invoices/       # /invoices pages
│   │   └── settings/       # /settings page
│   └── (docs)/             # Docs routes (standalone layout, no DB)
│       └── docs/           # /docs/* pages (mdsvex markdown)
```
...
2. **Build** — Builds the SvelteKit app (including docs routes)
3. **Deploy** — Publishes to GitHub Pages

The app and documentation are built together as a single SvelteKit application.
...
If the tests fail, the commit is rejected.
