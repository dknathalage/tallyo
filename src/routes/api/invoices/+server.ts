...
import type { CreateInvoiceInput } from '$lib/repositories/interfaces/types.js';
...
export const POST: RequestHandler = async ({ request }) => {
	...
	try {
		const id = await repositories.invoices.createInvoice(validated as CreateInvoiceInput, lineItems ?? []);
