		...
		<div class="flex items-center justify-between">
			...
			<div class="flex items-center gap-2">
				...
				{#if estimate.converted_invoice_id !== null}
					<a href="{base}/invoices/{estimate.converted_invoice_id}" class="inline-flex items-center gap-1 rounded-lg border border-gray-300 bg-white px-3 py-1.5 text-sm font-medium text-primary-600 hover:bg-gray-50 dark:border-gray-600 dark:bg-gray-700 dark:text-primary-400 dark:hover:bg-gray-600">
				...
				<Button variant="secondary" size="sm" onclick={() => goto(`${base}/estimates/${estimate?.id}/edit`)}>
					{i18n.t('common.edit')}
				</Button>
