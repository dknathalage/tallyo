<script lang="ts">
	...
	async function handleSubmit(
		...
		try {
			...
			void goto(resolve('/(app)/console/invoices/[id]', { id: String(data.invoice.id) }));
		} catch (e) {
...
<div class="space-y-6">
	<div class="flex items-center gap-3">
		<a href={resolve('/(app)/console/invoices/[id]', { id: String(data.invoice.id) })} class="text-gray-400 transition-colors hover:text-gray-600 dark:text-gray-500 dark:hover:text-gray-300" aria-label={i18n.t('a11y.backToInvoice')}>
