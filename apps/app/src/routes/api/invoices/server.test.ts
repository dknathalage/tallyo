...
describe('GET /api/invoices', () => {
	...
	it('calls markOverdueInvoices then getInvoices', async () => {
		vi.mocked(repositories.invoices.markOverdueInvoices).mockResolvedValue(undefined as any);
		vi.mocked(repositories.invoices.getInvoices).mockResolvedValue({ data: [], total: 0 } as any);
...
describe('GET /api/invoices/[id]', () => {
	...
	it('returns an invoice by id', async () => {
		...
		vi.mocked(repositories.invoices.getInvoice).mockResolvedValue(mockInvoice as any);
	...
	it('throws 404 if invoice not found', async () => {
		vi.mocked(repositories.invoices.getInvoice).mockResolvedValue(undefined as any);
